...
public sealed partial class MediaPlayerSection : Page
{
    ...
    public static readonly DependencyProperty ViewModelProperty =
        DependencyProperty.Register("ViewModel", typeof(SettingsViewModel), typeof(MediaPlayerSection), new PropertyMetadata(null));

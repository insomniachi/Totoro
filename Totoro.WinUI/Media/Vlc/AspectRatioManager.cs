...
internal class AspectRatioManager : MediaPlayerElementManagerBase
{
    ...
    protected override void OnVideoViewChanged(VideoView oldValue, VideoView newValue)
    {
    ...
    private void VideoView_SizeChanged(object sender, SizeChangedEventArgs args)
    {
        UpdateAspectRatio();
    }

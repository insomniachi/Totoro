...
public class PluginManager : IPluginManager, IEnableLogger
{
    ...
    public async Task Initialize()
    {
        try
        {
            ...
            var json = await _httpClient.GetStringAsync("https://raw.githubusercontent.com/insomniachi/AnimDL/plugins/Binaries/plugins.json");
            ...
            foreach (var item in newReleases)
            {
                ...
                var url = $"https://raw.githubusercontent.com/insomniachi/AnimDL/plugins/Binaries/{item.FileName}";

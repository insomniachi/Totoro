...
namespace Totoro.Plugins.Anime.YugenAnime.Tests;
...
public class StreamProviderTests
{
    ...
    {
        { Hyouka, Url.Combine(ConfigManager<Config>.Current.Url, "/anime/2016/hyouka/") }
    };
    ...
    public async Task GetStreams(string key)
    {
        ...
        // act
        var result = await sut.GetStreams(url, _allEpisodes ? Range.All : 2..2).ToListAsync();
